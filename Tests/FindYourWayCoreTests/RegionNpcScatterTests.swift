...
final class RegionNpcScatterTests: XCTestCase {
    ...
    func testEachConfiguredRegionHasThreeToFourSlots() {
        for region: RegionType in [.meadowOrigin, .village2, .village3, .seaCity, .harbor, .hotspringVillage, .valley, .snowMountain, .skyVillage, .mountainPalace, .magicCity, .holyCity, .skyCity] {
